...
Automatically detect and report exam violations from GDPR-cleared signals and raise acknowledgeable alarms — within 10 seconds, as teacher popup, event-list entry, persisted record, and timeline marker — with at most one warning per minute per ongoing violation (FSD §10, §11, US-04).
