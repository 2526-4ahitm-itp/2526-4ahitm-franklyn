...
Live screen monitoring for franklyn: a proctor watching up to six student screens in a paginated grid, zooming into one student, with view-only access, primary capture at 1080p / default 10 FPS, adaptive live-stream downscaling, a ≤10s latency target, no audio or multi-monitor capture, and visible per-student connection status (FSD §7, §15, US-03).
